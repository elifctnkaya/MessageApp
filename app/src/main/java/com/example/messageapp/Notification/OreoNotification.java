...
public class OreoNotification extends ContextWrapper {
    ...
    private static final String CHANNEL_ID = "com.example.messaging";
    private static final String CHANNEL_NAME = "messaging";
    private static final String CHANNEL_TANIM = "kanalMessaging";
    ...
    private void creatChannel() {
        ...
        channel.setDescription(CHANNEL_TANIM);
